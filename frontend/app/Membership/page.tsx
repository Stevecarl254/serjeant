...
const MembershipPage: React.FC = () => {
  ...
  const scrollToPackages = () => {
    const element = document.getElementById('membership-packages');
    if (element) {
        ...
        <div className="max-w-5xl mx-auto text-center md:text-left">
          ...
          <div className="flex gap-4 mt-8 justify-center md:justify-start">
            <button
              ...
              className={`px-4 py-2 rounded-lg font-semibold shadow-md transition ${activeTab === "who" ? "bg-[#002366] text-white" : "bg-white text-gray-900 border border-gray-300"
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-semibold shadow-md transition ${activeTab === "benefits" ? "bg-[#002366] text-white" : "bg-white text-gray-900 border border-gray-300"
                }`}
            >
