      ...
      >
        <div className="bg-gradient-to-r from-[#002366]/80 to-[#9e9210]/70 w-full h-full flex flex-col justify-center items-center px-6">
          ...
          <p className="mt-4 text-lg md:text-xl max-w-2xl">
            Reach out to the <span className="text-[#9e9210] font-semibold">Serjeant At Arms Society</span> team for inquiries, membership info, or general support.
          </p>
        </div>
      </section>
      ...
      <section className="w-full bg-[#f9f9f9] py-16 px-6 md:px-16">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg">
            <h2 className="text-2xl font-bold text-[#002366] mb-6">Send Us a Message</h2>
          ...
          <div className="flex flex-col gap-6">
            <div>
              <h3 className="text-xl font-bold text-[#002366] mb-2">Our Offices</h3>
