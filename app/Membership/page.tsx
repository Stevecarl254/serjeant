  ...
  return (
    <div className="w-full text-gray-900">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/membership-hero.jpg')",
      ...
      {/* Overview Section */}
      <section className="w-full py-16 px-6 md:px-16 bg-[#f9f9f9]">
        <div className="max-w-5xl mx-auto">
          <p className="text-lg mb-4">
            Membership provides exclusive access to events, leadership opportunities, and a network of like-minded individuals. Currently, we have <span className="font-bold text-[#9e9210]">1,200</span> active members across Kenya.
          </p>
